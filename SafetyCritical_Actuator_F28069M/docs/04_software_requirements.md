...
| SW-REQ-019 | Firmware shall reject unknown or malformed commands, latch UNKNOWN_COMMAND, force PWM safe-low, and report fault telemetry. | `unknown_command_log.txt` |
