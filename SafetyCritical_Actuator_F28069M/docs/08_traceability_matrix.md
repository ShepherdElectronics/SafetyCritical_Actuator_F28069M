...
| SW-REQ-006 | HAZ-005 | RST branch | final log, `09`, `11` reset captures | Pass |
...
| SW-REQ-011 | HAZ-004 | `Controller_LatchFault()` | `08`, `10`, `13` safe-low captures | Pass |
...
| SW-REQ-015 | HAZ-005 | RST while disabled | final log | Pass |
