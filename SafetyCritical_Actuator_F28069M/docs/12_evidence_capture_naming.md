...
## Serial-Only Robustness Evidence

| Test | Evidence |
|---|---|
| Reset while enabled negative test | `evidence/serial_logs/reset_while_enabled_log.txt` |
| Unknown/malformed command handling | `evidence/serial_logs/unknown_command_log.txt` |
