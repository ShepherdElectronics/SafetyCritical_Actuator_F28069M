...
Built a TI C2000 safety-oriented actuator command controller with SCI command input, ePWM actuator output, explicit state-machine control, fault-latched safe shutdown, CPU Timer0 communication timeout, telemetry, requirements traceability, and serial/scope verification evidence.
