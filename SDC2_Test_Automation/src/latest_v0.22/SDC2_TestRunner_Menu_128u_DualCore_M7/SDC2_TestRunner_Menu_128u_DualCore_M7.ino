/*
  ...
  Purpose:
    Full SDC2 characterization at 128 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 128 microsteps
    SW1 = U, SW2 = D, SW3 = D, SW4 = U
    Pulses per motor rev = 200 * 128 = 25600
...
const double MICROSTEP_SETTING = 128.0;     // R725 set to 128 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 128 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_128u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,128");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 128 ustep");
  zeroEncoder();
