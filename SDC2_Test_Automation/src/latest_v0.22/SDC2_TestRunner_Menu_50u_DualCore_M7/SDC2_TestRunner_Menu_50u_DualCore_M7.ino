/*
  ...
  Purpose:
    Full SDC2 characterization at 50 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 50 microsteps
    SW1 = D, SW2 = D, SW3 = U, SW4 = D
    Pulses per motor rev = 200 * 50 = 10000
...
const double MICROSTEP_SETTING = 50.0;     // R725 set to 50 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 50 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_50u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,50");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 50 ustep");
  zeroEncoder();
