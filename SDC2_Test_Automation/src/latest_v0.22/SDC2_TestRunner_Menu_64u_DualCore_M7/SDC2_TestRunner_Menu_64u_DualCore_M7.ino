/*
  ...
  Purpose:
    Full SDC2 characterization at 64 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 64 microsteps
    SW1 = D, SW2 = U, SW3 = D, SW4 = U
    Pulses per motor rev = 200 * 64 = 12800
...
const double MICROSTEP_SETTING = 64.0;     // R725 set to 64 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 64 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_64u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,64");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 64 ustep");
  zeroEncoder();
