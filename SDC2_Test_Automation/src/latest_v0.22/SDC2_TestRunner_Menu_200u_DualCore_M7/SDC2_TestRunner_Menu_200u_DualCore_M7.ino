/*
  ...
  Purpose:
    Full SDC2 characterization at 200 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 200 microsteps
    SW1 = D, SW2 = U, SW3 = D, SW4 = D
    Pulses per motor rev = 200 * 200 = 40000
...
const double MICROSTEP_SETTING = 200.0;     // R725 set to 200 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 200 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_200u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,200");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 200 ustep");
  zeroEncoder();
