/*
  ...
  Purpose:
    Full SDC2 characterization at 5 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 5 microsteps
    SW1 = U, SW2 = U, SW3 = U, SW4 = D
    Pulses per motor rev = 200 * 5 = 1000
...
const double MICROSTEP_SETTING = 5.0;     // R725 set to 5 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 5 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_5u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,5");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 5 ustep");
  zeroEncoder();
