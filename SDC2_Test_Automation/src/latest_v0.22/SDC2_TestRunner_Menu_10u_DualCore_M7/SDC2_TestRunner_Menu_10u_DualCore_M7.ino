/*
  ...
  Purpose:
    Full SDC2 characterization at 10 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 10 microsteps
    SW1 = D, SW2 = U, SW3 = U, SW4 = D
    Pulses per motor rev = 200 * 10 = 2000
...
const double MICROSTEP_SETTING = 10.0;     // R725 set to 10 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 10 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_10u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,10");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 10 ustep");
  zeroEncoder();
