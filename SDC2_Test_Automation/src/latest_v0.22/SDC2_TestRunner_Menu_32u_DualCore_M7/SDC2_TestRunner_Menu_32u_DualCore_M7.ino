/*
  ...
  Purpose:
    Full SDC2 characterization at 32 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 32 microsteps
    SW1 = U, SW2 = U, SW3 = D, SW4 = U
    Pulses per motor rev = 200 * 32 = 6400
...
const double MICROSTEP_SETTING = 32.0;     // R725 set to 32 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 32 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_32u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,32");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 32 ustep");
  zeroEncoder();
