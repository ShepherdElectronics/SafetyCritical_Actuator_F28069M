/*
  ...
  Purpose:
    Full SDC2 characterization at 4 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 4 microsteps
    SW1 = D, SW2 = U, SW3 = U, SW4 = U
    Pulses per motor rev = 200 * 4 = 800
...
const double MICROSTEP_SETTING = 4.0;     // R725 set to 4 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 4 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_4u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,4");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 4 ustep");
  zeroEncoder();
