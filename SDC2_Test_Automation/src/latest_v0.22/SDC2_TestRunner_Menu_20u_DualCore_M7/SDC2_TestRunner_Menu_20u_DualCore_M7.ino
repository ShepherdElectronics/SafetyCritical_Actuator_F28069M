/*
  ...
  Purpose:
    Full SDC2 characterization at 20 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 20 microsteps
    SW1 = U, SW2 = D, SW3 = U, SW4 = D
    Pulses per motor rev = 200 * 20 = 4000
...
const double MICROSTEP_SETTING = 20.0;     // R725 set to 20 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 20 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_20u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,20");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 20 ustep");
  zeroEncoder();
