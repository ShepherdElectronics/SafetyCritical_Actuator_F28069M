/*
  ...
  Purpose:
    Full SDC2 characterization at 8 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 8 microsteps
    SW1 = U, SW2 = D, SW3 = U, SW4 = U
    Pulses per motor rev = 200 * 8 = 1600
...
const double MICROSTEP_SETTING = 8.0;     // R725 set to 8 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 8 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_8u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,8");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 8 ustep");
  zeroEncoder();
