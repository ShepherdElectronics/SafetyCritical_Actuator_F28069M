/*
  ...
  Purpose:
    Full SDC2 characterization at 180 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 180 microsteps
    SW1 = D, SW2 = D, SW3 = D, SW4 = D
    Pulses per motor rev = 200 * 180 = 36000
...
const double MICROSTEP_SETTING = 180.0;     // R725 set to 180 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 180 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_180u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,180");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 180 ustep");
  zeroEncoder();
