/*
  ...
  Purpose:
    Full SDC2 characterization at 100 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 100 microsteps
    SW1 = U, SW2 = U, SW3 = D, SW4 = D
    Pulses per motor rev = 200 * 100 = 20000
...
const double MICROSTEP_SETTING = 100.0;     // R725 set to 100 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 100 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_100u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,100");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 100 ustep");
  zeroEncoder();
