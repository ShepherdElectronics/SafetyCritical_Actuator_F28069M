/*
  ...
  Purpose:
    Full SDC2 characterization at 2 microsteps.

  IMPORTANT HARDWARE SETTING:
    R725 = 2 microsteps
    SW1 = U, SW2 = U, SW3 = U, SW4 = U
    Pulses per motor rev = 200 * 2 = 400
...
const double MICROSTEP_SETTING = 2.0;     // R725 set to 2 ustep
...
void printHeader() {
  Serial.println("# SDC2 Full Characterization Firmware - 2 ustep");
  Serial.println("# FirmwareVersion,SDC2_FullChar_2u_ISR_Realtime_DualCore_M7_v2");
  Serial.println("# R725_MICROSTEP_SETTING,2");
...
void runDebugTest() {
  Serial.println("# Starting DEBUG test at 2 ustep");
  zeroEncoder();
